...
export default function Grid() {
  ...
  return (
    <div className="m-auto h-screen bg-white p-4 w-full">
      ...
      <h2 className="mt-4 text-xl font-bold underline">
      ...
      <div className="grid grid-rows-3 grid-flow-col gap-4">
        <div className="row-span-3 bg-cyan-300 p-4 rounded-lg text-center">
          01
        </div>
        <div className="col-span-2 bg-cyan-500 p-4 rounded-lg text-center">
          02
        </div>
        <div className="row-span-2 col-span-2 bg-cyan-700 p-4 rounded-lg text-center">
          03
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 auto-rows-min gap-4 p-4 bg-gray-100 border border-gray-700">
        ...
        <div className="bg-purple-500 text-white p-6 rounded-xl">Item 4</div>
